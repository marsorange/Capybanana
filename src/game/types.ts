...
export interface Trip {
  ...
  // Flavor pre-generated by the LLM at departure (destination/duration are
  // decided then too). Stats stay the fixed effect table — this is text only.
  // Absent → the postcard is composed procedurally at return.
  llmPostcard?: {
    title: string;
    message: string;
    landmark: string;
